...
function cargarXML(xml) {
  ...
  for (let i = 0; i < discosXML.length; i++) {
    let nombre = discosXML[i].getElementsByTagName("nombre")[0].textContent;
    let grupo = discosXML[i].getElementsByTagName("grupo")[0].textContent;
    let anno = discosXML[i].getElementsByTagName("anno")[0].textContent;
    let tipo = discosXML[i].getElementsByTagName("tipo")[0].textContent;
    let localizacion =
      discosXML[i].getElementsByTagName("localizacion")[0].textContent;
    let prestado = discosXML[i].getElementsByTagName("prestado")[0].textContent;
    let caratula = discosXML[i].getElementsByTagName("caratula")[0].textContent;
