...
window.addEventListener('load', function() {
    ...
    let numVisitas = document.getElementById('numVisitas');
    ...
    if (nombre != null){
        ...
        numVisitas.textContent = "Número de visitas: " + visitas;
    }
 });
...
document.getElementById("jugar").addEventListener("click", function(){
    ...
    let nombre = document.forms["formularioJugador"]["nombreJugador"].value;
