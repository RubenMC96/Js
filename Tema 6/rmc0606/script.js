...
function iniciar(){
    ...
    let texto1 = document.createTextNode(`El numero total de parrafos es: ${totalParrafos}`)
    ...
    let texto2 = document.createTextNode(`El texto del segundo parrafo es: ${parrafos[1].textContent}`);
    ...
    let texto3 = document.createTextNode(`El numero total de enlaces es: ${totalEnlaces}`)
    ...
    let texto4 = document.createTextNode(`La direccion del enlace 1 es: ${direcEnlace1}`);
    ...
    let texto5 = document.createTextNode(`La direccion del penultimo enlace es: ${direcEnlaceN}`);
    ...
    // let primeParrago = parrafos[0];
    // let enlacesParrafo1 = primeParrago.enlaces;
    // let numEnlaces = enlacesParrafo1.length;
    // let texto7 = document.createTextNode(`El primer parrado tiene ${numEnlaces}`);
